package tw.graphics
{
	...
	public class PieMenu2
	{
		...
		public function PieMenu2 (startAngle:Number, endAngle:Number, rollAngle:Number, clickAngle:Number, radius:Number, displayList:Array, events:Array=null) {
		...
		public function enlarge (index:uint, select:Boolean = false):void {
			...
			if (_pieEvent) {
				Events.say(_pieEvent[index]);
				trace(_pieEvent[index]);
			}
		}
